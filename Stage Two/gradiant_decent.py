...
class GradiantDecent:
    ...
    def algorithm(x, y, iteration, learning_rate, min_random_value, max_random_value):

        mse_list, m_list, b_list = [], [], [] #y = mx + b
        ...
        for i in range((int(iteration))):
            ...
            if val1 > 0:
                ...
                val1 = val1 - learning_rate
                
                if val2 >= 0:
                    
                    val2 = val2 - learning_rate
